    ...
    if recovery_decision == 'y': #Recovering Data from previous analyse
            ...
            if any(x == "1" for x in steps_list): # Data Slicer
                ...
                while loop == 0:
                    ...
                    if plot_decision == 'y':
                        ...
                        mf.Classification (ClassificationPar, min_g, max_g, 0.25, n_a, True) #(Parametros do data-set,  min_grid_size, max_grid_size, numero de vezes a simular, plotar matriz de confusão (True or False))

                        loop += 1
                    
                    elif plot_decision == 'n':

                        mf.Classification (ClassificationPar, min_g, max_g, 0.25, n_a, False) #(Parametros do data-set,  min_grid_size, max_grid_size, numero de vezes a simular, plotar matriz de confusão (True or False))
        ...
        if mode_decision == '2': #Direct Mode script
            ...
            if plot_decision == 'y':
                ...
                mf.Classification (ClassificationPar, min_g, max_g, 0.25, n_a, True) #(Parametros do data-set,  min_grid_size, max_grid_size, pace, numero de vezes a simular, plotar matriz de confusão (True or False))
